...
def LCSBackTrack(v:str, w:str, penalty=0, method='', matchScore=1) -> [StrMat, int, int, int]:
...
def longestWeightedPath(sortedWtPaths:WPaths, source:str) -> [int, Strs]:
